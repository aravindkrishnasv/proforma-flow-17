...
import { Plus, Trash2, Eye, Save, Printer } from "lucide-react";
  ...
  useEffect(() => {
    ...
    const generateNewInvoiceNumber = async () => {
      try {
        ...
        setInvoiceNumber(`INV-${currentYear}-${String(newCount).padStart(3, '0')}`);
      } catch (error) {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-3">
              <Button onClick={handlePreview} variant="outline" className="w-full"><Eye className="h-4 w-4 mr-2" />Preview Invoice</Button>
              <Button onClick={handleSave} className="w-full"><Save className="h-4 w-4 mr-2" />Save Invoice</Button>
            </div>
          </div>
        </div>
      </div>
        ...
        <DialogContent className="max-w-4xl h-[90vh] flex flex-col p-0">
          ...
          <ScrollArea className="flex-1">
            <div className="p-6" id="invoice-preview-content">
              {/* This is the content that will be previewed and printed */}
